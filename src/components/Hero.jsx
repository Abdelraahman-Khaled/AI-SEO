  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute h-5 w-5   rounded-full top-1/2 left-full -translate-x-1/2 -translate-y-1/2 border border-white inline-flex items-center justify-center  ">
      ...
      <div className="container relative mt-16">
        <h1 className="text-8xl md:text-[168px] md:leading-none font-semibold tracking-tighter bg-white text-transparent bg-clip-text bg-[radial-gradient(100%_100%_at_top_left,white,white,rgb(74,32,138,0.5))] text-center">
          AI SEO
        </h1>
